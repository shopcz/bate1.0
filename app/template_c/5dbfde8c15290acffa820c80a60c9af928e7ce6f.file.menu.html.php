<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-04-19 20:09:19
         compiled from "D:\web\htcdos\shopcz\app\views\admin\menu.html" */ ?>
<?php /*%%SmartyHeaderCode:2202155339aef06e650-02806185%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5dbfde8c15290acffa820c80a60c9af928e7ce6f' => 
    array (
      0 => 'D:\\web\\htcdos\\shopcz\\app\\views\\admin\\menu.html',
      1 => 1429421795,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2202155339aef06e650-02806185',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_55339aef25a9c3_32880624',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55339aef25a9c3_32880624')) {function content_55339aef25a9c3_32880624($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
>
	<style type="text/css">
		...
		.explode {background: url(<?php echo @constant('RESOURCE_PATH');?>
images/menu_minus.gif) no-repeat 0px 3px; font-weight: bold;}
		.collapse { background: url(<?php echo @constant('RESOURCE_PATH');?>
images/menu_plus.gif) no-repeat 0px 3px; font-weight: bold;}
		.menu-item { background: url(<?php echo @constant('RESOURCE_PATH');?>
images/menu_arrow.gif) no-repeat 0px 3px; font-weight: normal;}
	...
	<div id="tabbar-div">
		<p>
			<span style="float:right; padding: 3px 5px;">
				<a href="javascript:toggleCollapse();"><img id="toggleImg" src="<?php echo @constant('RESOURCE_PATH');?>
images/menu_minus.gif" width="9" height="9" border="0" alt="闭合"></a>
			</span>
			...
			<ul id="menu-ul">
				...
				<li class="explode" key="04_order" name="menu"> 订单管理        
					<ul style="display: block;">
						<li class="menu-item"><a href="index.php?p=admin&c=order&a=index" target="main-frame">订单列表</a></li>
...
function toggleCollapse()
{
  ...
  collapse = !collapse;
  document.getElementById('toggleImg').src = collapse ? '<?php echo @constant('RESOURCE_PATH');?>
images/menu_minus.gif' : '<?php echo @constant('RESOURCE_PATH');?>
